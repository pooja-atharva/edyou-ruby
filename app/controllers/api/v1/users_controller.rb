module Api
  class V1::UsersController < V1::BaseController
    ...
    def index
      ...
      school_users = User.joins(:profile).search(search_params[:query]).where('profiles.high_school' => high_school).filter_on(filter_params)
      non_school_users = User.joins(:profile).search(search_params[:query]).where.not('profiles.high_school' => high_school).filter_on(filter_params)
